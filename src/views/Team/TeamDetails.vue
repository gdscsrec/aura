<template>
  <v-content
    class="px-3 mx-0 pb-5"
    :class="$vuetify.theme.dark == true ? 'black' : 'grey lighten-5'"
  >
          ...
          <v-container fluid>
            <v-row>
              <v-col md="3" lg="3" sm="4" cols="12" class="text-center">
                ...
                <p class="google-font mt-3" style="font-size: 120%">
                  {{ MemberDetails.name }}
                </p>
                ...
                <v-chip
                  ...
                  >Active</v-chip
                >
                <v-chip class="ma-1" v-else label dark color="red" small
                  >Not Active</v-chip
                >
              </v-col>

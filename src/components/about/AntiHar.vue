  ...
  <v-container fluid class="py-0 my-0 mt-5">
    ...
    <v-row class="py-0 my-0">
      <v-col md="8" sm="12" cols="12" class="py-0 my-0">
        <div class="google-font" style="font-size: 100%">
          <b style="font-size: 120%"
            >Why do we have an official Anti-Harassment policy for
            {{ data }} events?</b
          >

          <ul class="mt-2" style="font-size: 100%">
            <li class="google-font">
        ...
        <div class="google-font" style="font-size: 110%">
          <b style="font-size: 120%"
            >{{ data }} is dedicated to providing a harassment-free event
          ...
          <span class="google-font" style="font-size: 100%"
        ...
        <div class="google-font" style="font-size: 100%">
          ...
          comply immediately. <br /><br />
          Exhibiting partners and guests are also subject to the anti-harassment
          policy. In particular, exhibitors and speakers should not use
          sexualized images, activities, or other material, or otherwise create
          a sexualized environment in their slide decks, exhibit material,
          ...
          volunteer immediately. Organizers and event volunteers may be
          ...
          helping participants contact venue security or local law enforcement,
          provide escorts, or otherwise assist these experiencing harassment to
          fell safe for the duration of the event.
          <br /><br />
          Though we hope that we never have to invoke this policy, we believe
          that having this document helps everyone think a little more about how
          their actions and words affect the whole community, as well as

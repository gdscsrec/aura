<template>
  <div>
    ...
    >
      ...
      <div class="pa-3">
        <p class="google-font ma-0 mt-2" style="font-size: 110%">
          {{ data.data.title | summary(20) }}
        </p>
        <p class="google-font mt-0 mb-0" style="font-size: 90%">
          {{ data.data.pubDate }}
        </p>
        <p class="google-font mt-0 mb-4" style="font-size: 90%">
          {{ data.data.author }}
        </p>
    ...
    <div class="d-md-none d-lg-none">
      <v-card class="mx-auto" max-width="100%" outlined>
        <v-list-item three-line>
          <v-list-item-content>
            <div class="mb-4 google-font">
              {{ data.data.pubDate | dateFilter }}
            </div>
            <v-list-item-title
              class="mb-1 google-font"
              style="font-size: 120%"
              >{{ data.data.title | summary(20) }}</v-list-item-title
            >
            ...
            <v-list-item-subtitle
              ...
              v-html="
                $options.filters.summary(filterData(data.data.description), 50)
              "
            ></v-list-item-subtitle>
          </v-list-item-content>

<template>
  <v-container fluid class="pa-0 ma-0">
    ...
    <v-card
      v-else-if="Object.keys(speaker).length > 0"
      flat
      class="ma-0 pa-0"
      color="transparent"
    >
      <v-card-title
        ...
        :style="{
          'background-image':
            'url(' + require('@/assets/img/dontremove/spakerhead.jpg') + ')',
        }"
          ...
          <v-row align="center">
            <v-col cols="12" class="text-center pa-2">
              ...
              <p
                ...
                style="font-size: 150%"
                :style="{
                  color: this.$vuetify.theme.dark ? 'white' : '#424242',
                }"
              >
                {{ speaker.name }}
              </p>
              <p class="google-font my-0" style="font-size: 110%">
                {{ speaker.designation }}
              </p>
              <p
        ...
        <v-container fluid>
          <v-row>
            <v-col md="12" lg="12" sm="12" cols="12" class="text-center">
              ...
              <p class="google-font">
                The requested URL /{{ this.$route.params.id }} was not found on
